...
<div class='container-fluid'>
	<div class='row mt-4'>
		<div>
			<center>
				<h4 class='py-2' style='background-color: #3399ff; color: #FFFFFF'>Po co ten portal?</h4>
			</center>
		</div>
	</div>
	<div class='row mt-2'>
		...
		<div class='col-sm-8'>
			...
			<p><i class='fas fa-angle-double-right text-info'></i> Głównym atutem portalu jest bieżąca aktualizacja przez operatorów, co jest potwierdzone datą i godziną oznaczoną jako: "Stan na dzień".</p>
                        ...
                        <p><i class='fas fa-angle-double-right text-info'></i> Pliki źródłowe oraz plik bazy danych w MySQL jest dostępny pod adresem: <a target="#blank" href="https://github.com/ksiezycpl/pomagamyuk">https://github.com/ksiezycpl/pomagamyuk</a></p>
		</div>
		<div class='col-sm-2'>
		</div>
	</div>	
