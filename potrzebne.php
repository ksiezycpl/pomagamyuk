...
<?php include_once("nav.php"); ?>
	...
	<div class='row mt-4'>
		<div>
			<center>
				<h4 class='py-2' style='background-color: #3399ff; color: #FFFFFF'>Potrzebne <?php echo $nazwa_kategorie__glowne; ?></h4>
			</center>
		</div>
	</div>
	...
	<?php
		...
		while ($wiersz_kategorie__podkategorie_poziom_0 = mysqli_fetch_array($result_kategorie__podkategorie_poziom_0)){
			...
			$sql_towary_poziom_0 = "SELECT * FROM towary WHERE kategorie__podkategorie_id = ".$id_wiersz_kategorie__podkategorie_poziom_0." AND pokaz = 1";
			...
			while ($wiersz_kategorie__podkategorie_poziom_1 = mysqli_fetch_array($result_kategorie__podkategorie_poziom_1)){
				...
				$sql_towary_poziom_1 = "SELECT * FROM towary WHERE kategorie__podkategorie_id = ".$id_wiersz_kategorie__podkategorie_poziom_1." AND pokaz = 1";
