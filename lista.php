...
if (@$_POST['update_towar']==true)
{
    ...
    $query = "UPDATE towary SET nazwa='$edycja_towaru_nazwa', opis='$edycja_towaru_opis', zapotrzebowanie='$edycja_towaru_zapotrzebowanie', ile_dostepne='$edycja_towaru_dostepnosc', j_m='$edycja_towaru_jednostka_miary'  WHERE id='$toward_id'";
    $result = mysqli_query($link,$query);
    print true;
    exit;
}
if (@$_POST['nowy_towar']==true)
{
    ...
    $query = "INSERT INTO towary SET nazwa='$edycja_towaru_nazwa', opis='$edycja_towaru_opis', zapotrzebowanie='$edycja_towaru_zapotrzebowanie', ile_dostepne='$edycja_towaru_dostepnosc', j_m='$edycja_towaru_jednostka_miary', 	kategorie__glowne_id='$edycja_kategoria1', kategorie__podkategorie_id='$podgrupa'";
    $result = mysqli_query($link,$query);
    print true;
    exit;
}
...
<?php include_once("nav.php"); ?>
	<div class='row mt-4'>
		<div>
			<center>
				<h4 class='py-2' style='background-color: #3399ff; color: #FFFFFF'>Przeglądasz <?php echo $nazwa_kategorie__glowne.", ".$nazwa_kategorie__podkategorie_poziom_0.", ".$nazwa_kategorie__podkategorie_poziom_1; ?></h2>
			</center>
...
print "<div class='row mt-3'>
		...
		$sql_towary = "SELECT * FROM towary WHERE kategorie__podkategorie_id = ".$id_kategorie__podkategorie." AND pokaz = 1";
...
<div class="modal fade modal_edytuj" tabindex="-1" id="modal_edytuj" tabindex="-1" aria-labelledby="modal_edytuj" aria-hidden="true">
	...
	<div class="modal-content">
		...
		<div class="mb-3 ">
		    ...
		    <input type="text" class="form-control edycja_towaru_nazwa" id="recipient-name">
